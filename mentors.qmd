...
We have proposed a 3-year collaboration with NOAA Fisheries modeled after the NASA Openscapes Framework that would start in July 2023. Learn more about the approach to leading NASA Openscapes here: [openscapes.github.io/approach-guide/mentors-framework](https://openscapes.github.io/approach-guide/mentors-framework)
...
Through facilitation and practical training for mentoring, teaching, and coaching, the mentors will build skills and strategies to support colleagues with diverse comfort levels with software and coding, while also strengthening relationships across centers/offices. Through this, mentors will identify and co-create on common resources and activities – such as code or databases for identical tasks or community developed standard practices – so there is less reinventing at each center. 

We will meet remotely twice monthly and also collaborate asynchronously (e.g. Google Chat, GitHub). Mentors will also focus on teaching NMFS colleagues through Champions cohorts and Community Skills Workshops (see section 2), with support from Openscapes staff. Openscapes will manage any experimental software licenses (e.g. RStudio Cloud) to support Mentors interested in collaborating, teaching, and experimenting with big data on the cloud.
...
12/12 | 5. Open communities and coding strategies for future us | Coordinate Champions cohorts for Feb-March
...
We will also start identifying cross-center roadblocks that mentors can collaborate on throughout the next years. Previous roadblocks the NMFS mentor community is now involved in at the policy level include whether and how researchers at different science centers can use GitHub.

### January-May

Our bi-weekly meetings now include the [NASA Openscapes Mentors](https://nasa-openscapes.github.io/mentors.html) for the first time. The NASA mentors join our NMFS Openscapes mentor group that meet already [California WaterBoards/Cal EPA mentors](https://cawaterboarddatacenter.github.io/swrcb-openscapes/) and [Pathways to Open Science mentors](https://openscapes.github.io/pathways-to-open-science/). From January-May we are learning coaching skills with Tara Robertson, a DEI consultant and leadership coach who has [worked with Openscapes since 2021](https://www.openscapes.org/blog/2021/05/27/tara-robertson/).
